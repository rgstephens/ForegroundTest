...
public class FGServiceBridgeModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod startService(Promise promise) {
        ...
        try {
            Log.d(REACT_CLASS, "startService - 1");
            Intent intent = new Intent("com.foregroundtest.ForegroundService");
            Log.d(REACT_CLASS, "startService - 2");
            intent.setClass(this.getReactApplicationContext(), ForegroundService.class);
            Log.d(REACT_CLASS, "startService - 3");
            getReactApplicationContext().startService(intent);
            Log.d(REACT_CLASS, "startService - 4");
